			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
				...
				<div className='relative'>
					...
					<select
						...
						className='w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent appearance-none cursor-pointer transition-all'
					>
