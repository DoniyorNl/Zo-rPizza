		...
		try {
			...
			const invoiceData: InvoiceData = {
				...
				items: order.items.map(
					(item: { quantity: number; price: number; product: { name: string }; size?: string }) => ({
			...
			if (!isProd) console.error('Chek yuklash xatosi:', err)
			alert(
				'Chekni yuklab olishda xatolik. Keyinroq "Mening buyurtmalarim" sahifasidan urinib ko\'ring.',
			)
		} finally {
				...
				<Card className='border-2 border-green-200 shadow-lg'>
					<CardContent className='pt-8 pb-8'>
						<div className='text-center'>
							...
							<p className='text-gray-600 mb-1'>Buyurtma tayyorlanmoqda.</p>
							{orderNumber && (
